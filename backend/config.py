...
SESSION_TIMEOUT_MINUTES = "120"  # Default session timeout in minutes (2 hours)
class AppConfig:
    SECRET_KEY = os.environ.get("ERP_SECRET_KEY", "erp-secret")
    DEBUG = os.environ.get("FLASK_DEBUG", "1") == "1"
    PORT = int(os.environ.get("PORT", "5000"))
    PERMANENT_SESSION_LIFETIME = timedelta(minutes=int(os.environ.get("ERP_SESSION_TIMEOUT_MINUTES", SESSION_TIMEOUT_MINUTES)))
