...
export default function Wareneingaenge() {
    ...
    return <>
        ...
        data={offeneBestellungen.map(item => ({ ...item, prozess: getPurchaseStepLabel(getPurchaseStep(item, einkaufsdokumente)) }))}
        ...
        rowActions={[
            ...
            { name: "book", label: "Wareneingang buchen", permission: "lager.buchen", onClick: buchen, isVisible: row => canBookGoodsReceipt(row, einkaufsdokumente) }
        ]}
        />
    </>;
}
